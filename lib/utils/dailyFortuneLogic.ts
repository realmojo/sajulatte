...
const TEXT_DB = {
  summary: {
    HAP: [
      ...
      '마치 퍼즐 조각이 딱 맞춰지는 듯한 날입니다. 꼬였던 일들이 제자리를 찾고 평온이 찾아옵니다.',
      '당신의 매력이 주변을 환하게 밝히는 날입니다. 사람들과 어울리며 즐거운 에너지를 나누세요.',
      '오랜 친구나 반가운 인연을 만날 수 있는 행운의 날입니다. 연락처를 뒤적여보세요.',
      '작은 노력으로도 큰 기쁨을 얻을 수 있는 가성비 최고의 하루! 효율이 아주 좋습니다.',
      '무엇을 해도 칭찬받는 날이니 자신감을 가지세요. 오늘은 당신이 주인공입니다.',
    ],
    CHUNG: [
      ...
      '계획대로 되지 않아도 실망하지 마세요. 오히려 전화위복의 기회가 되어 더 좋은 결과를 가져올 수 있습니다.',
      '오늘은 내비게이션 없이 낯선 길을 가는 듯합니다. 모험을 즐기는 마음가짐으로 임하면 의외의 즐거움을 찾을 수 있습니다.',
      '갑작스러운 약속 변경이나 취소에 당황하지 마세요. 그 빈 시간이 당신에게 꼭 필요한 휴식이 될 수 있습니다.',
      "의견 충돌은 피하는 것이 상책입니다. 오늘만큼은 '네, 알겠습니다'가 마법의 주문입니다.",
      '물건을 떨어뜨리거나 잃어버리지 않도록 소지품을 잘 챙기세요. 꼼꼼함이 불운을 막습니다.',
    ],
    WONJIN: [
      ...
      '이유 없이 짜증이 난다면 잠시 눈을 감고 심호흡을 하세요. 내 마음의 날씨가 흐린 탓이지, 세상 탓이 아닙니다.',
      '가까운 사람일수록 예의를 지켜야 합니다. 익숙함에 속아 소중함을 잃지 마세요.',
      '남의 떡이 더 커 보이는 날입니다. 비교는 불행의 시작이니 내 손에 쥐어진 작은 행복에 만족하세요.',
      '혼자만의 공간에서 좋아하는 영화를 보며 리프레시하는 것이 최고의 처방입니다. 사람 냄새가 때로는 피곤할 수 있습니다.',
      '오해가 생기기 쉬운 날이니 중요한 말은 문자로 남기는 것이 좋습니다. 기록은 기억보다 정확합니다.',
      '오늘 느끼는 서운함은 내일이면 사라질 감정입니다. 감정에 휘둘려 관계를 망치지 마세요.',
    ],
    HYEONG: [
      ...
      '수리하거나 고쳐야 할 물건이 있다면 오늘이 적기입니다. 미뤄왔던 AS를 맡기세요.',
      '몸이 찌뿌둥하다면 스트레칭으로 풀어주세요. 굳은 몸과 마음을 유연하게 만들어야 사고를 예방합니다.',
      '지나친 완벽주의는 독이 됩니다. 오늘은 80점만 맞아도 충분하다고 스스로를 다독이세요.',
      '규칙을 어기려는 유혹을 뿌리치세요. 오늘은 원칙대로 하는 것이 가장 빠르고 안전한 길입니다.',
      '따끔한 충고를 듣더라도 겸허히 받아들이세요. 양약은 입에 쓴 법입니다.',
      '조급해질수록 일이 꼬입니다. 엉킨 실타래를 풀듯이 하나씩 차근차근 해결해 나가세요.',
    ],
    NORMAL_GOOD: [
      ...
      '특별할 것 없는 일상이지만, 그 평범함 속에 감사함이 깃든 날입니다.',
      '오랜만에 푹 잤거나 밥맛이 꿀맛인, 소소하지만 확실한 행복이 있는 날입니다.',
      '길을 걷다 우연히 마주친 풍경이 가슴 벅차게 아름답게 느껴지는 감성적인 하루입니다.',
      '당신의 작은 친절이 누군가에게는 큰 위로가 되는 날입니다. 베풂의 기쁨을 누리세요.',
      '밀린 숙제를 끝낸 듯 개운한 기분을 느낄 수 있습니다. 홀가분한 마음으로 저녁을 즐기세요.',
      '좋아하는 음악 한 곡으로 하루의 에너지가 충전됩니다. 오늘은 당신이 DJ입니다.',
    ],
    NORMAL_SOSO: [
      ...
      '오늘은 무대 뒤에서 휴식을 취하는 배우와 같습니다. 화려한 조명은 없지만 누구보다 평온합니다.',
      '잠시 멍 때리는 시간도 필요합니다. 뇌에게도 휴식을 선물하세요.',
      '너무 애쓰지 않아도 괜찮습니다. 흐르는 물처럼 유유자적하게 보내세요.',
      "오늘은 '내일의 나'에게 일을 조금 미루어도 세상이 무너지지 않습니다. 게으름을 조금 피워보세요.",
      '따뜻한 차 한 잔의 여유가 큰 힘이 되는 잔잔한 하루입니다.',
      '별일 없이 지나가는 것이야말로 가장 큰 행운일 수 있습니다. 무탈함에 감사하세요.',
    ],
  },
  love: {
    MEN: [
      ...
      '당신의 묵묵한 배려가 그녀의 마음을 흔드는 날입니다. 말보다 행동으로 보여주세요.',
      '오늘은 유머 감각을 발휘해보세요. 함께 웃다 보면 어느새 마음의 거리가 좁혀져 있을 것입니다.',
      '안경을 벗거나 머리를 올려보는 등 작은 변화만으로도 시선을 사로잡을 수 있습니다.',
      '솔직한 고백은 타이밍입니다. 오늘 느낌이 온다면 주저하지 마세요.',
      "그녀의 사소한 변화를 알아차려 주세요. '머리했네?' 한마디가 점수를 땁니다.",
      '함께 맛집을 찾아가는 등 미각을 자극하는 데이트가 성공 확률을 높입니다.',
      '가벼운 스킨십이 두 사람 사이의 전기를 통하게 할 수 있습니다. 손을 잡거나 어깨를 살짝 감싸보세요.',
      '그녀의 고민을 진지하게 들어주는 것만으로도 당신은 이미 최고의 남자친구 후보입니다.',
      '오늘은 계산기를 두드리지 마세요. 베푸는 만큼 사랑으로 돌아옵니다.',
      '깜짝 선물을 준비해보세요. 장미 한 송이나 작은 초콜릿도 감동을 주기에 충분합니다.',
      '눈을 맞추며 대화하세요. 진심 어린 눈빛은 백 마디 말보다 강력합니다.',
      '그녀의 취미나 관심사에 대해 물어보세요. 공감대가 형성되면 관계는 급속도로 발전합니다.',
      '밤늦은 시간 센치해진 타이밍을 노려 연락해보세요. 깊은 대화가 오갈 수 있습니다.',
      '오늘은 자존심을 버리고 먼저 연락하는 용기가 필요합니다.',
      '질투 유발 작전은 금물입니다. 오로지 그녀만을 바라보는 해바라기가 되세요.',
    ],
    WOMEN: [
      ...
      '오늘은 청순가련한 컨셉보다는 섹시하고 도발적인 모습이 통하는 날입니다.',
      '눈맞춤을 피하지 마세요. 그 사람도 당신을 보고 싶어 했습니다.',
      '먼저 연락하는 것을 두려워하지 마세요. 당신의 톡 하나에 그 사람은 하루 종일 행복해할 것입니다.',
      '칭찬은 고래도 춤추게 하고 썸남의 심장도 뛰게 합니다. 사소한 것이라도 칭찬해주세요.',
      '술자리에서의 실수를 조심하세요. 귀여운 주정은 괜찮지만 선을 넘으면 안 됩니다.',
      '오늘은 튕기지 마세요. 밀당하다가 줄 끊어질 수 있습니다.',
      '그 사람의 친구들과 어울릴 기회가 있다면 적극 참여하세요. 점수를 딸 좋은 기회입니다.',
      'SNS에 잘 나온 셀카를 한 장 올려보세요. 그 사람에게서 연락이 올지도 모릅니다.',
      '함께 걷는 것만으로도 설레는 날입니다. 편안한 신발을 신고 산책 데이트를 즐기세요.',
      '가끔은 엉뚱한 모습이 매력으로 다가갈 수 있습니다. 너무 완벽해 보이려 애쓰지 마세요.',
      '그 사람 앞에서는 스마트폰을 내려놓고 온전히 그에게 집중하세요.',
      '나의 고민을 털어놓으며 기대보세요. 남자는 여자가 자신에게 의지할 때 존재감을 느낍니다.',
      '오늘은 운명적인 만남보다는 편안한 만남이 어울리는 날입니다.',
      '지나간 사랑에 미련을 두지 마세요. 새로운 사랑이 문 앞에 와 있습니다.',
      '나 자신을 사랑하는 것이 가장 큰 매력입니다. 자신감을 가지세요.',
    ],
    COUPLE_BAD: [
      ...
      '사랑싸움은 칼로 물 베기라지만, 오늘은 칼날이 날카롭습니다. 조심하세요.',
      '상대방의 기분이 저기압일 때는 건드리지 않는 것이 상책입니다. 긁어 부스럼 만들지 마세요.',
      '오늘은 각자의 취미 생활을 즐기며 적당한 거리를 유지하는 것이 평화의 비결입니다.',
      '말꼬리 잡지 마세요. 논리적으로 이기려다 사랑을 잃을 수 있습니다.',
      '기념일을 깜빡하지 않았는지 확인해보세요. 사소한 무관심이 큰 싸움이 됩니다.',
      '선의의 거짓말이라도 오늘은 들통나기 쉽습니다. 솔직함이 최선입니다.',
      '상대방의 가족이나 친구를 비난하지 마세요. 돌이킬 수 없는 강을 건너는 격입니다.',
      '대화 도중 말을 끊지 마세요. 끝까지 들어주는 인내심이 필요합니다.',
      '화가 나더라도 막말은 절대 금물입니다. 쏟아진 물은 주워담을 수 없습니다.',
      '오늘 헤어지자는 말은 홧김에 나온 말일 확률이 높습니다. 진심으로 받아들이지 마세요.',
    ],
    SINGLE_GOOD: [
      ...
      '마음에 드는 사람에게 연락처를 물어봐도 좋은 날입니다. 용기 있는 자가 사랑을 얻습니다.',
      '도서관이나 서점에서 지적인 매력을 가진 사람을 만날 수 있습니다.',
      '반려동물과 산책을 하다가 자연스럽게 대화가 시작될 수 있습니다.',
      '비 오는 날 우산이 없다면 누군가와 함께 쓸 기회가 생길지도 모릅니다.',
      '오늘은 집에 일찍 들어가지 마세요. 밖에서 당신의 인연이 기다리고 있습니다.',
      '옷깃만 스쳐도 인연이라는데, 오늘은 옷깃 스칠 일이 많습니다.',
      '누군가 당신을 지긋이 바라보고 있다면 외면하지 말고 미소로 화답하세요.',
      '친구의 친구, 지인의 지인 등 건너 건너 아는 사람과의 만남을 기대해보세요.',
      '당신의 이상형과는 정반대의 사람에게 끌리는 신기한 경험을 할 수 있습니다.',
      '꿈속에서 본 사람이 현실에 나타날지도 모릅니다. 데자뷔를 경험할 수 있는 날입니다.',
    ],
    NORMAL: [
      ...
      '따뜻한 포옹 한 번이 백 마디 말보다 위로가 되는 날입니다.',
      '함께 옛날 사진을 보며 추억 여행을 떠나보는 것도 좋습니다.',
      '서로에게 손편지를 써보는 건 어떨까요? 아날로그 감성이 통하는 날입니다.',
      '가벼운 산책을 하며 손을 잡고 걷는 것만으로도 충분합니다.',
      '사랑은 받는 것이 아니라 주는 것임을 기억하세요. 먼저 배려하면 배로 돌아옵니다.',
      '오늘은 상대방의 이야기를 경청하는 것이 사랑을 키우는 방법입니다.',
      '연인이 있든 없든, 당신은 충분히 사랑받을 자격이 있는 사람입니다.',
      '사랑의 적령기는 바로 지금입니다. 너무 늦었다고 생각하지 마세요.',
      '때로는 말이 없는 침묵도 대화가 될 수 있습니다.',
      '사랑에도 휴식이 필요합니다. 잠시 떨어져 있어도 믿음은 변치 않습니다.',
    ],
  },
  marriage: {
    GOOD: [
      ...
      '배우자와 함께하는 산책이 로맨틱 영화의 한 장면처럼 느껴집니다.',
      '오늘 저녁은 외식보다는 둘이서 요리하며 알콩달콩한 시간을 보내세요.',
      '서로의 빈자리를 채워주는 든든한 동반자임을 다시 한번 확인하는 날입니다.',
      '옛 연애 시절의 추억을 이야기하며 웃음꽃을 피워보세요.',
      '배우자를 위해 작은 서프라이즈 선물을 준비하면 감동이 배가 됩니다.',
      '함께 미래의 계획을 세우기에 좋은 날입니다. 꿈을 공유하며 희망을 키우세요.',
    ],
    BAD: [
      ...
      '시댁이나 처가 문제로 다툼이 생길 수 있습니다. 현명하게 대처하세요.',
      '자녀 교육 문제로 이견이 생길 수 있습니다. 서로의 방식을 존중하며 타협점을 찾으세요.',
      '과거의 섭섭했던 일을 꺼내지 마세요. 지금의 행복까지 망칠 수 있습니다.',
      '피곤하다는 핑계로 대화를 피하지 마세요. 소통의 부재가 오해를 낳습니다.',
      '배우자의 자존심을 건드리는 말은 절대 금물입니다.',
      '오늘은 혼자만의 시간을 가지며 감정을 추스르는 것이 낫습니다.',
    ],
    NORMAL: [
      ...
      '오늘 저녁은 배달 음식으로 간단하게 해결하고 영화 한 편 보는 건 어떨까요?',
      '말없이 곁에 있어 주는 것만으로도 큰 위로가 되는 날입니다.',
      '부부 동반 모임에 나가기에 무난한 날입니다.',
      '집안 대청소를 함께 하며 묵은 먼지를 털어내세요. 마음까지 상쾌해집니다.',
      '소박한 밥상에도 정성이 가득하다면 최고의 만찬입니다.',
      '서로의 건강을 챙겨주며 비타민 같은 하루를 보내세요.',
    ],
  },
  money: {
    GOOD: [
      ...
      '빌려줬던 돈을 돌려받거나 잊고 있던 비상금을 발견할 수 있습니다.',
      '쇼핑하기 좋은 날입니다. 마음에 쏙 드는 물건을 파격적인 가격에 득템할 수 있습니다.',
      '지인이 좋은 정보를 가져다줍니다. 귀를 열어두면 돈이 들어옵니다.',
      '오늘은 밥값을 먼저 내도 아깝지 않습니다. 더 큰 이득으로 돌아올 것입니다.',
      '취미로 했던 일이 수익으로 연결될 수 있는 기회가 찾아옵니다.',
    ],
    BAD: [
      ...
      '가족이나 연인과의 금전 문제로 속앓이를 할 수 있습니다.',
      '주식이나 코인 시장이 요동칠 수 있습니다. 멘탈을 잘 붙잡으세요.',
      '보이스피싱이나 스팸 문자를 조심하세요. 오늘은 의심하는 것이 약입니다.',
      '물건을 잃어버리고 다시 사야 할 일이 생길 수 있습니다.',
      '무이자 할부의 유혹을 뿌리치세요. 다음 달의 내가 괴로워집니다.',
    ],
    NORMAL: [
      ...
      '가계부를 정리하며 지출 내역을 점검하기 좋은 날입니다.',
      '필요한 곳에는 돈을 써야 합니다. 건강을 위한 지출은 아끼지 마세요.',
      '중고 거래를 통해 안 쓰는 물건을 처분하기에 좋습니다.',
      '더치페이가 깔끔합니다. 오늘은 계산을 정확하게 하세요.',
      '재테크 관련 서적이나 영상을 보며 공부하는 것이 남는 장사입니다.',
    ],
  },
  job: {
    PROMOTION: [
      ...
      '당신의 능력을 시기하는 사람이 생길 정도로 잘나가는 날입니다. 겸손함만 갖춘다면 무적입니다.',
      '중요한 프레젠테이션이나 발표가 있다면 대성공을 거둡니다. 무대의 주인은 당신입니다.',
      '스카우트 제의나 이직 제의가 들어올 수 있습니다. 당신의 몸값이 올라가고 있습니다.',
      '어려운 문제를 해결하여 영웅이 되는 날입니다. 위기가 곧 기회입니다.',
      '거래처와의 미팅이 성공적으로 마무리됩니다. 계약 성사의 기운이 강합니다.',
    ],
    CREATIVE: [
      ...
      '영감이 떠오르면 즉시 메모하세요. 훗날 큰 자산이 될 아이디어입니다.',
      '기존의 방식을 뒤집는 혁신적인 시도가 통하는 날입니다.',
      '예술적인 취미 활동이 직업적 영감으로 이어질 수 있습니다.',
      '멘토와의 대화에서 번뜩이는 깨달음을 얻을 수 있습니다.',
      '당신의 독창성이 빛을 발하여 주변의 부러움을 삽니다.',
    ],
    STRESS: [
      ...
      '상사의 이유 없는 트집에 멘탈이 흔들릴 수 있습니다. 한 귀로 듣고 흘리세요.',
      '컴퓨터나 기기 고장으로 업무에 차질이 생길 수 있습니다. 백업은 필수입니다!',
      '책임질 일이 생긴다면 변명보다는 빠른 인정과 수습이 낫습니다.',
      '갑작스러운 업무 폭탄을 맞을 수 있습니다. 우선순위를 정해 차근차근 처리하세요.',
      '퇴사 욕구가 치솟는 날입니다. 하지만 오늘은 감정적인 판단을 내리기에 적절치 않습니다.',
    ],
    NORMAL: [
      ...
      '동료와 커피 한 잔의 여유를 가지며 정보를 교환하기 좋은 날입니다.',
      '자신의 업무 환경을 정리 정돈해보세요. 능률이 오릅니다.',
      '오늘은 야근보다는 정시 퇴근을 목표로 하세요. 저녁이 있는 삶을 즐기세요.',
      '업무 매뉴얼을 다시 한번 점검하며 기본기를 다지는 것이 좋습니다.',
      '큰 사고 없이 하루가 저무는 것에 감사하세요.',
    ],
  },
  health: {
    GOOD: [
      ...
      '머리가 맑아지고 아이디어가 번뜩입니다. 두뇌 회전이 빠른 날입니다.',
      '어떤 음식을 먹어도 소화가 잘 됩니다. 맛집 탐방을 가도 좋겠습니다.',
      '평소보다 운동 수행 능력이 향상됩니다. 최고 기록을 경신할 수도 있습니다.',
      '금연이나 금주를 결심하기에 좋은 날입니다. 의지가 강해집니다.',
      '건강검진 결과가 좋게 나올 수 있는 운수입니다.',
    ],
    BAD: [
      ...
      '과음이나 과식을 주의하세요. 위장이 파업을 선언할 수 있습니다.',
      '목이나 허리 통증이 심해질 수 있습니다. 바른 자세를 유지하세요.',
      '눈이 침침하고 피로할 수 있습니다. 스마트폰을 멀리하고 눈 찜질을 해주세요.',
      '불면증이 찾아올 수 있습니다. 따뜻한 우유 한 잔과 가벼운 독서가 도움이 됩니다.',
      '감기 기운이 있다면 초기에 잡아야 합니다. 오늘은 약속을 취소하고 몸을 돌보세요.',
    ],
    NORMAL: [
      ...
      '물을 자주 마셔 수분을 보충하세요. 피부에도 건강에도 좋습니다.',
      '스트레칭으로 굳은 근육을 수시로 풀어주는 것이 좋습니다.',
      '영양제를 챙겨 먹으며 부족한 영양소를 보충하세요.',
      '자연식 위주의 식단이 몸을 편안하게 합니다.',
      '잠들기 전 명상이 꿀잠을 선물합니다.',
    ],
  },
  human: {
    GOOD: [
      ...
      '당신의 유머 감각에 사람들이 배꼽을 잡습니다. 분위기 메이커 역할을 톡톡히 합니다.',
      '약속 장소에서 우연히 반가운 얼굴을 마주칠 수 있습니다.',
      '누군가에게 베푼 호의가 더 큰 보답으로 돌아옵니다.',
      '당신의 조언이 누군가에게 큰 힘이 되어줍니다. 경청과 공감이 빛나는 날입니다.',
      '팀워크가 최상입니다. 함께하면 못 할 것이 없습니다.',
    ],
    BAD: [
      ...
      '믿었던 사람에게 배신감을 느낄 수 있습니다. 너무 깊은 속사정은 말하지 마세요.',
      'SNS에서의 말실수가 꼬리표처럼 따라다닐 수 있습니다. 업로드 버튼을 누르기 전에 세 번 생각하세요.',
      '남의 싸움에 끼어들지 마세요. 고래 싸움에 새우 등 터집니다.',
      '빌려준 물건이나 돈 때문에 의가 상할 수 있습니다.',
      '상대방의 무례한 태도에 화가 나더라도 똑같이 대응하지 마세요. 당신의 품격만 떨어집니다.',
    ],
    NORMAL: [
      ...
      '새로운 사람보다는 익숙한 사람들과 어울리는 것이 편안한 날입니다.',
      '가벼운 스몰 토크로 분위기를 부드럽게 만드세요.',
      '남의 일에 지나친 관심은 끄는 것이 좋습니다. 내 할 일에 집중하세요.',
      '감정 소모가 없는 담백한 관계가 좋습니다.',
      '오늘의 적이 내일의 동지가 될 수 있습니다. 적을 만들지 마세요.',
    ],
  },
};
...
const seededPickMultiple = (arr: string[], dateSeed: string, count: number = 3) => {
  if (!arr || arr.length === 0) return [];
  // If array is smaller than count, return all but shuffled slightly to not look static (optional, but here simply return all)
  // Or better, just return all of them if count >= length
  if (arr.length <= count) return arr;

  const result: string[] = [];
  const takenIndices = new Set<number>();

  // Try to pick distinct indices
  let i = 0;
  while (result.length < count && i < 50) {
    const currentSeed = dateSeed + '_pick_' + i;
    let hash = 0;
    for (let j = 0; j < currentSeed.length; j++) {
      hash = (hash << 5) - hash + currentSeed.charCodeAt(j);
      hash |= 0;
    }
    const index = Math.abs(hash) % arr.length;
...
export const getDailyFortune = (
  ...
  const pick = (arr: string[], category: string) => {
    const list = seededPickMultiple(arr, dateString + '_' + category, 3);
    return list.join('\n\n');
  };
