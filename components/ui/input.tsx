  ...
  ({ className, placeholderClassName, ...props }, ref) => {
    return (
      <TextInput
        ...
        placeholderTextColor={props.placeholderTextColor ?? '#a1a1aa'} // zinc-400 equivalent approx or use theme var if possible? NativeWind handles classes but placeholderTextColor prop needs string.
        {...props}
      />
    );
  }
