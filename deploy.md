...
// 키스토어 생성 (최초 1회만)
cd android/app
keytool -genkeypair -v -storetype PKCS12 -keystore sajulatte-release.keystore -alias sajulatte-key-alias -keyalg RSA -keysize 2048 -validity 10000
...
// 키스토어 정보 확인
keytool -list -v -keystore sajulatte-release.keystore

// 키스토어 파일은 android/app/ 폴더에 생성됨
// ⚠️ 중요: 키스토어 파일과 비밀번호는 안전하게 보관하세요!

// 키스토어 설정 방법 1: android/gradle.properties 파일에 직접 추가 (비추천)
// MYAPP*RELEASE_STORE_FILE=app/sajulatte-release.keystore
// MYAPP_RELEASE_KEY_ALIAS=sajulatte-key-alias
